package com.warriorprod.fooddeliveryapp.Service;
...
import com.warriorprod.fooddeliveryapp.OrderStatus;
...
public class ListenOrder extends Service implements ChildEventListener {
    ...
    private void showNotification(String key, Request request) {
        ...
        PendingIntent conentIntent = PendingIntent.getActivity(getBaseContext(),0,intent,PendingIntent.FLAG_UPDATE_CURRENT);
